...
export default function CVPreview({ data, previewRef }) {
  return (
    <div className="bg-gray-100 mt-[20px] sm:mt-0 p-6 rounded-lg shadow-inner">
      {/* Bọc thêm div cho scroll */}
      <div className="overflow-x-auto">
        <div
          ref={previewRef}
          className="mx-auto bg-white border border-gray-200 text-gray-800 w-[794px] rounded-lg shadow-lg overflow-hidden"
        >
          {/* Header */}
          <div className="w-full bg-gradient-to-r bg-black to-indigo-500 text-white px-8 py-6 flex gap-6 items-center">
